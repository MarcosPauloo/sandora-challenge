...
export function AuthLayout({leftContent, rightContent}: AuthLayoutProps) {
  return (
    <main className="flex flex-col lg:flex-row min-h-screen">
      {/* Lado esquerdo */}
      <section aria-labelledby="right-heading" className="w-full lg:w-1/2 bg-primary-foreground flex flex-col justify-center items-start px-8 md:px-16 py-5 md:py-10 relative">
      ...
      {/* Lado direito */}
      <section aria-labelledby="left-heading" className="w-full lg:w-1/2 flex items-start lg:items-center justify-center px-8 py-10 lg:py-0 lg:px-8 bg-primary text-base flex-1">
